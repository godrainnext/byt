            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <View style={{ alignItems: 'center' }}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-around', width: pxToDp(280), alignItems: 'center' }}>
                    ...
                    <TouchableOpacity style={{ alignItems: 'center' }} onPress={jubao}>
                  ...
                  <TouchableOpacity onPress={() => {
                    ...
                    style={{ borderWidth: pxToDp(1), borderColor: 'black', height: pxToDp(25), width: pxToDp(200), borderRadius: pxToDp(12), alignItems: 'center', marginTop: pxToDp(20) }}>
