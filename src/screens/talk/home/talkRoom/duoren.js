        ...
        return (
          ...
          >
            ...
            >
              <ImageBackground
                style={{ flex: 1 }}
                source={require('../../../../res/sucai/13.jpg')}
              >
                {/**顶部 */}
                <View
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    <View>
                      ...
                      />
                      <Text style={{ color: 'white', fontSize: 16 }}>避雨</Text>
                    </View>
                    <TouchableOpacity
                      style={{
                        borderRadius: pxToDp(32),
                  ...
                  >
                    <SvgUri
                      svgXmlData='<svg t="1631176303657" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2963" width="200" height="200"><path d="M1013.44 484.736l-170.24-212.992a42.752 42.752 0 0 0-47.488-13.632 42.688 42.688 0 0 0-28.416 40.192v127.808H426.432a85.12 85.12 0 0 0 0 170.304h340.736v127.872a42.496 42.496 0 0 0 75.84 26.56l170.432-212.992a42.176 42.176 0 0 0 0-53.12z m-416.64 367.36H255.36c-46.72 0-84.608-38.08-84.608-85.12v-512c0-46.72 38.144-84.544 85.312-84.544h340.736a85.12 85.12 0 0 0 0-170.24H170.88A170.432 170.432 0 0 0 0.448 170.496v681.6a170.432 170.432 0 0 0 170.432 170.432h425.984a85.12 85.12 0 0 0 0-170.432z" p-id="2964" fill="#707070"></path></svg>'
                      width="20"
                      height="20"
                    />
                  </TouchableOpacity>
                ...
                >
                  ...
                  />
                  <Text style={{ fontSize: pxToDp(14), marginTop: pxToDp(4) }}>
                    避雨
                  </Text>
                </TouchableOpacity>
                {/**伙伴头像 */}
                ...
                >
                  <TouchableOpacity style={styles.box}>
                    <Image
                      style={styles.image}
                      source={{
                        uri: 'https://img2.baidu.com/it/u=1299709147,2175986875&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=500'
                      }}
                    />
                  ...
                  <TouchableOpacity style={styles.box}>
                    <Image
                      style={styles.image}
                      source={{
                        uri: 'https://img0.baidu.com/it/u=447812639,2223354455&fm=253&fmt=auto&app=120&f=JPEG?w=300&h=275'
                      }}
                    />
                  ...
                  <TouchableOpacity style={styles.box}>
                    <Image
                      style={styles.image}
                      source={{
                        uri: 'https://img2.baidu.com/it/u=649750005,2251881577&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=519'
                      }}
                    />
                ...
                <WebView
                  ...
                  // source={{ html: HTML }}
                  source={{
                    uri: 'file:///android_asset/static.bundle/liuyan.html'
                  }}
                  originWhitelist={['*']}
