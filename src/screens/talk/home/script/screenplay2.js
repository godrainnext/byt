...
class Index extends PureComponent {
  renderInner = () => (
    <Fragment>
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 你今年是十六岁了？
      </Text>
      <Text style={styles.Text}>
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 师太！师太为何啼哭？
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>:
        噢噢，未曾啼哭，我在念经！
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 要念经！要念经！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 为何不数下去？
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 就是这尊长眉大仙。
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 长眉大仙为何发笑啊？
      </Text>
      <Text style={styles.Text}>
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>（唱）</Text>:
        他笑我自己身世不知晓，亲生娘亲把我抛。劬劳大恩不能报， 枉在金榜把名标。
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>:
        他笑你是个好的！你是个好的！
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 我看他……，他在笑你！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 啊？笑我什么呀？
      </Text>
      <Text style={styles.Text}>
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 送子娘娘有什么用处？
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>:
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 这是童子拜观音！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 我看他是儿子求母亲！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 是善才童子拜观音！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 是亲生儿子求娘亲！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 啊？
      </Text>
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>: 如此学生告辞了！
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>:
        解元公！解元公！解元公！啊？
      ...
      <Text style={styles.Text}>
        <Text style={styles.texthead}>王志贞（白）</Text>: 他是……，他是无名神。
      </Text>
      <Text style={styles.Text}>
        <Text style={styles.texthead}>徐元宰（白）</Text>:
        我看他不是神，他是我父申……
