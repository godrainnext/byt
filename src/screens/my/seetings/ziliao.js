  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1, backgroundColor: this.state.backgroundColor }}>
        ...
        />
        <View style={{ width: '90%', height: '75%', backgroundColor: '#fff', alignSelf: 'center', borderRadius: 32, marginTop: pxToDp(60) }}>
          <View style={s.avatar} >

            <View style={{ position: 'absolute', left: pxToDp(100), top: pxToDp(-60) }}>
              <View style={{ borderWidth: 5, borderRadius: 100, padding: 6, borderColor: this.state.backgroundColor }}>
                <Avatar
          ...
          <TouchableOpacity style={{ marginTop: pxToDp(60) }} onPress={() => this.context.navigate('Nickname')}>
            <View style={s.basic}>
          ...
          <TouchableOpacity onPress={() => this.context.navigate('Signature')}>
            ...
            <View style={s.basic, [{ flexDirection: 'row' ,marginLeft:pxToDp(20),marginTop:pxToDp(20)}]}>
              <Image source={require('./sheng.png')} style={{width:30,height:50}}/>
              <CheckBox
                checkedColor='#01a3f8'
                title='男'
              ...
              />
               <Image source={require('./dan.png')} style={{width:30,height:50,marginLeft:pxToDp(60)}}/>
              <CheckBox
                title='女'
                checked={!this.state.sex}
          ...
          <View style={{ width: '50%', alignSelf: 'center', borderRadius: pxToDp(16), overflow: 'hidden', marginTop: pxToDp(50) }}>
...
const s = StyleSheet.create({
  ...
  basic: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: '#e2f4fe', marginLeft: pxToDp(15),
    height: 90, width: '90%'
  },
  button: {
    marginTop: pxToDp(20),
