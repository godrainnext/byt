  ...
  render() {
    return (
      <View style={{ backgroundColor: '#e2f4fe', flex: 1 }}>
        ...
        >
          <Text style={{ margin: pxToDp(20), fontSize: pxToDp(20) }}>
            越剧自诞生到现在百年有余，发源于浙江嵊州，发祥于上海，繁荣于全国，流传于世界，在发展中汲取了昆曲、话剧、绍剧等特色剧种之大成，经历了由男子越剧到女子越剧为主的历史性演变。但在现如今快节奏的生活中，已经很少有人有耐心去体会越剧的美妙。
            {'\n'}
