  ...
  <View>
      ...
      {this.props.comments.map((item,commentid)=>(
       ...
       <View style={{flexDirection:'row'}}>
                    ...
                    <TouchableOpacity  style={{position:'absolute',right:20,top:20}} onPress={()=>{this.setState({isvisible:true})}}>
                    ...
                    <View style={{flexDirection:'row',position:'absolute',right:20,bottom:10}}>
                    <TouchableOpacity>
                        <SvgUri svgXmlData={dianzan} width='20' height='20' style={{marginRight:20}}/>
                    </TouchableOpacity>
                    <TouchableOpacity>
                    ...
                    <View style={{flexDirection:'row',position:'absolute',right:20,bottom:10,backgroundColor:'#fff'}}>
                    <SvgUri svgXmlData={dianzan} width='20' height='20' style={{marginRight:20}}/>
                    <SvgUri svgXmlData={pinglun} width='20' height='20'/>
                    </View>
                     </View>
