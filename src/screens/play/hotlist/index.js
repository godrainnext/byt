...
class Index extends PureComponent {
    constructor(props) {
        ...
        this.state = {
            book: [
                {
                    id: '4', title: "皇帝与村姑", context: "在兵荒马乱的年代里，镇海县张家村一个善良纯朴的姑娘张帏君冒死解救了一个落难壮士——皇储康王的性命。",
                ...
                {
                    id: '5', title: "柳永", context: "科举落第之后，柳永过着尤红殢翠、耽溺诗酒的放浪生涯，一封妻子的书信敦促他谨记十年前离乡别井的初衷，他悔恨交加，立志科场进取。后虽再试中榜，却因《鹤冲天》一词冒犯朝廷而又落第，悲愤之余的柳永，无奈地自嘲自己为“奉旨填词柳三变”。",
                ...
                {
                    id: '6', title: "蝴蝶梦", context: "《蝴蝶梦》是我国首部水墨越剧电影，在嵊州市首映后取得观众的一致好评。剧中以庄周试妻的情节，摒弃了以往男尊女卑、女人是祸水的封建思想，而且注入了许多的女性人文关怀，强烈地突出了以田秀为代表的中国古代女子自尊自强、追求人格独立的精神。",
                ...
                {
                    id: '7', title: "北地王", context: "历史剧。庄志1957年编剧。该剧取材于古典小说《三国演义》，在原玉兰剧团《国破山河在》剧本基础上，参考川、京、湘、汉等剧种的剧本改编而成。写魏军攻蜀，蜀后主刘禅沉溺酒色，不听其子北地王刘谌劝谏，决意降魏。刘谌悲愤回宫，其妻知情，伏剑殉国；刘谌杀子，继赴祖庙，哭告先帝后自刎。",
                ...
                {
                    id: '8', title: "甄嬛", context: "越剧《甄嬛》是由时任上海越剧院院长的李莉根据小说《甄嬛传》改编的连台本越剧，分上下两本推出。上本由年轻演员担纲：李旭丹饰甄嬛、杨婷娜饰皇帝、王清饰清河王、史燕彬饰沈眉庄、王柔桑饰温实初、裘丹莉饰华贵妃、陈慧迪饰安 陵容、王婕饰槿汐。下本则由中生代明星领衔：王志萍饰甄嬛、钱惠丽饰皇帝、黄慧饰清河王、陈颖饰华贵妃",
                    path: 'https://img1.baidu.com/it/u=4190329434,4054880381&fm=26&fmt=auto&gp=0.jpg',
                },
                {
                    id: '9', title: "早春二月", context: "萧涧秋，一位身怀抱负的小学教员，热切地爱恋着活泼秀美的少女陶岚，但同时又深深同情孤独无援的寡妇文嫂，为帮助她毅然放弃自己的幸福……",
                ...
                {
                    id: '10', title: "家", context: "根据巴金同名小说改编。新编现代越剧《家》，是上海越剧院为庆贺我国当代文学巨匠巴金百年诞辰耳精心策划、制作的一部成功剧目。",
            ...
            <ScrollView style={{ backgroundColor: 'white', flex: 1, marginBottom: pxToDp(10) }}>
                <ImageBackground source={require('../../../res/jfbg.jpg')} style={{ height: pxToDp(150) }}>
                    ...
                    <View style={styles.title}>
                        ...
                        <Text style={{ fontSize: pxToDp(13), color: 'white' }}>以近7天的剧本点击阅读量为准</Text>
                    </View>
                </ImageBackground>
                {/**榜单第一 */}
