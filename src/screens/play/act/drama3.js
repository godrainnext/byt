...
class Index extends PureComponent {
    state = {
        dramalist: {
            ...
            text1: '《梁山伯与祝英台》是中国汉族民间四大爱情故事之一，其他三个是《白蛇传》、《孟姜女哭长城》、《牛郎织女》。其中，《梁祝传说》是中国最具魅力的口头传承艺术及国家级非物质文化遗产，也是唯一在世界上产生广泛影响的中国民间传说。自西晋始，在民间流传已有一千七百多年，可谓中国家喻户晓，流传深远，被誉为爱情的千古绝唱。从古到今，有无数人被梁山伯与祝英台的悲惨爱情所感染。《梁山伯与祝英台》与《罗密欧与朱丽叶》齐名。后来被艺术家们搬到舞台上，经典剧目是越剧的《梁祝》。',
        ...
        return (
            <View style={{ backgroundColor: '#E2F4FE' }}>
                ...
                >
                    ...
                    />
                    <Text style={{ fontSize: pxToDp(20), fontWeight: 'bold', marginBottom: pxToDp(20), marginTop: pxToDp(10) }}>
                    ...
                    >
                        <Text style={{ fontSize: pxToDp(16), fontWeight: 'bold', marginBottom: pxToDp(10) }}>
                            剧情简介
                        </Text>
                    ...
                    <View style={{ marginTop: pxToDp(10) }}>
                        <Text style={{ fontSize: pxToDp(16), fontWeight: 'bold', marginBottom: pxToDp(20) }}>
                            演出历史
                        </Text>
                        <Text style={{ fontSize: pxToDp(14), marginBottom: pxToDp(20),lineHeight:pxToDp(22),color:'#333333'}}>
                    ...
                    <View>
                        <Text style={{ fontSize: pxToDp(14), fontWeight: 'bold', marginBottom: pxToDp(10) }} onPress={() => this.context.navigate('ScreenPlay3')}>
                            剧本详情
                        </Text>
