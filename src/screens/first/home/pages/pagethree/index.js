...
class Index extends PureComponent {
  state = {
    roleList: [
      {
        id: '1', name: '王文娟', next: 'Wangwenjuan', place: '浙江绍兴', birth: '1926年12月19日', genre: '王派', job: '花旦',
      ...
      {
        id: '2', name: '陆锦花', next: 'Lujinhua', place: '福建', birth: '1927年2月25日', genre: '陆派', job: '小生',
      ...
      {
        id: '3', name: '戚雅仙', next: 'Qiyaxian', place: '浙江余姚', birth: '1928年2月', genre: '戚派', job: '花旦',
      ...
      {
        id: '4', name: '袁雪芬', next: 'Yuanxuefen', place: '浙江嵊县', birth: '1922年3月26日', genre: '袁派', job: '青衣、闺门旦',
      ...
      {
        id: '5', name: '徐玉兰', next: 'Xuyulan', place: '浙江富阳', birth: '1921年12月27日', genre: '徐派', job: '小生',
      ...
      {
        id: '6', name: '吕瑞英', next: 'Lvruiying', place: '上海', birth: '1933年1月19日', genre: '吕派',
        job: '花旦',
      ...
      {
        id: '7', name: '毕春芳', next: 'Bichunfang', place: '浙江鄞县', birth: '1927年7月14日', genre: '毕派', job: '小生',
      ...
      {
        id: '8', name: '范瑞娟', next: 'Fanruijuan', place: '浙江绍兴', birth: '1924年1月6日', genre: '范派', job: '小生',
      ...
      {
        id: '9', name: '张云霞', next: 'Zhangyunxia', place: '上海', birth: '1926年7月', genre: '张派', job: '花旦',
      ...
      {
        id: '10', name: '金采风', next: 'Jincaifeng', place: '上海', birth: '1930年', genre: '金派', job: '闺门旦、花旦',
