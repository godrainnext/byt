        ...
        <View style={{ marginVertical: 2, padding: 10 }}>
          <View style={{ marginVertical: 2, padding: 10 }}>
            <View>
              ...
              <Text style={{ fontSize: pxToDp(14), color: 'gray' ,marginTop:pxToDp(12)}}>
