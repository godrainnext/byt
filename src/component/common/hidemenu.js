    ...
    this.state = {
      daddata: [
        ...
        },
        {
          ...
          name: '张桂凤',
          detail1:
            '张桂凤（1922年11月13人-2012年3月4日），生于浙江萧山坎山镇，中国国家一级演员，越剧十姐妹之一，擅长老生。1945年，加入雪声剧团。1947年，参与越剧十姐妹的联合义演。同年加入东山越艺社。1951年参加华东越剧实验剧团。1955年转为上海越剧院主要演员。张桂凤',
          detail2:
            '在越剧老生方面颇有艺术功底，被称作“张桂凤派”。代表作有《梁山伯与祝英台》、《二堂放子》、《打金枝》、《李娃传》等。传人有董柯娣、章海灵、张承好等。',
          warn: '本站的全部概述文字在知识共享署名-相同方式共享3.0协议之条款下提供，附加条款亦可能应用。（请参阅使用条款）',
          kid: [
        ...
        },
        {
          ...
          name: '姚水娟',
          detail1:
            '姚水娟（1916年-1976年），原名姚文贤，生于中国嵊县后山镇，越剧女演员，工小旦，被誉为“越剧皇后。\n 1939年，与魏素云组成云水剧团，1940年，与李艳芳组成越华剧团，1951年，姚水娟加入浙江越剧”',
          detail2:
            '实验剧团。1961年，进入浙江省艺术学校教学。1976年，因患癌症去世。',
          warn: '本站的全部概述文字在知识共享署名-相同方式共享3.0协议之条款下提供，附加条款亦可能应用。（请参阅使用条款）',
          kid: [
        ...
        },
        {
          ...
          name: '徐天红',
          detail1:
            '徐天红（1925年9月13日-），生于浙江余姚，越剧女演员，擅演老生，为一级演员。1941年，参加天星越剧团。1945年，参加红星越剧团。1946年，组建天红越剧团，1947年8月，参与《山河恋》联合义演，为“越剧十姐妹”之一。1950年2月，与戚雅仙组建合作越剧团，担任团',
          detail2:
            '长。1950年9月，与尹桂芳重新组建芳华越剧团。1960年8月，进入上海越剧院。代表作《梁祝》（饰演祝公远）、《二堂放子》（饰演刘彦昌）等。被誉为“越剧第一老生”。',
          warn: '本站的全部概述文字在知识共享署名-相同方式共享3.0协议之条款下提供，附加条款亦可能应用。（请参阅使用条款）',
        ...
        },
        {
          ...
          name: '红楼梦',
          detail1:
            '红楼梦，越剧古装戏，越剧代表剧目之一。为剧作家徐进于1958年所编写一出越剧剧目，由于其为首度将整个《红楼梦》的故事完整地呈现於戏剧舞台，且以优美的台词、唱词，细致的表现手法，丰富的人物个性塑造，再配合上越剧本身语言的特色，以及主演者徐玉兰、王文娟等人的',
          detail2:
            '演技及优秀嗓音，使其在1958年2月18日于上海首演以来，广受到欢迎，其后并在1959年在北京作为国庆10周年演出，至1962年该剧在香港被拍成戏曲电影，使之更加广为流传。越剧《红楼梦》成为当代戏剧中红楼戏的经典代表作，后来两岸三地改编的红楼戏曲及电影，或受其影响，或试图改弦更张以超越之。而这部戏也不断重新演出，1990年代以后， 开始由新一代的越剧演员来演出此剧。',
          warn: '本站的全部概述文字在知识共享署名-相同方式共享3.0协议之条款下提供，附加条款亦可能应用。（请参阅使用条款）',
          kid: [
            { id: '1', title: '创作地点', message: '上海' },
            { id: '2', title: '时期', message: '中国（清）' },
            { id: '3', title: '编写者', message: '徐进' },
            { id: '4', title: '代表人物', message: '' },
            { id: '5', title: '思想主张', message: '' },
            { id: '6', title: '创始人', message: '' },
            { id: '7', title: '时间', message: '' },
            { id: '8', title: '尺寸', message: '' },
            { id: '9', title: '题材', message: '' }
          ]
        }
      ]
